#!/usr/bin/env python3
"""Track 2 (Growth Inflection) — SP500 universe, 2013-01-31 → 2024-12-31.

Uses the SP500 snapshot cache (derived from RUSSELL1000 cache) if available.

Outputs
-------
  data/results/track2_SP500_2013_2024_1m_report.md
"""
...
def _generate_report(result: BacktestResult, output_path: Path) -> None:
    ...
    lines: list[str] = [
        "# Track 2 — SP500 Universe — Backtest Report",
        "",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Track 2 SP500 backtest")
    parser.add_argument(
    ...
    try:
        ...
        log.info("Running Track 2 walk-forward …")
        ...
        report_path = RESULTS_DIR / "track2_SP500_2013_2024_1m_report.md"
        ...
        print("\n" + "═" * 55)
        print("  Track 2 — SP500 — 2013-01-31 → 2024-12-31")
        print("═" * 55)
