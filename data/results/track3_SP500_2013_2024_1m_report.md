...
**Snapshot window:** 2013-01-31 → 2024-12-31  
**First test month:** 2015-01-31 (after 24-month warm-up)  
**Generated:** 2026-05-25 11:11 UTC
...
|--------|-----------|-------------------|
| Total return | 298.94% | 259.15% |
| Excess return | 39.80% | — |
| Annualised Sharpe | 0.61 | — |
| Maximum drawdown | -22.43% | — |
| Hit rate (12m forward) | 73.48% | — |
| Avg picks / month | 12.4 | — |
| Unique tickers ever picked | 116 | — |
| Test months with ≥ 1 pick | 120 | — |
| Hit-rate observations | 1493 | — |

---

## Conclusion

Track 3 (Value Recovery) **outperformed** the SP500 benchmark (298.94% vs 259.15%, excess 39.80%).

Hit rate: **73.48%** across 1493 individual 12-month pick observations.

Sharpe of **0.61** (above 0.5 — risk-adjusted return appears non-trivial).
